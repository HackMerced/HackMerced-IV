        ...
        <div className="container">
          <div className="column left">
            <div className="question">
              ...
              <p>All undergraduate and graduate students of any major or high school students are welcome! High school students and those under the age of 18 are required to fill out a <a href="https://risk.ucmerced.edu/sites/risk.ucmerced.edu/files/documents/waiver-voluntary.pdf
" target="_blank" style={{color:"#fff"}}>liability waiver</a> and have it sent to <a href="mailto:general@hackmerced.com?subject=HackMerced Questions&body=Dear HackMerced," style={{textDecoration:"none", color:"#D7AA27"}}>general@hackmerced.com</a></p>
            </div>
            <div className="question">
          ...
          <div className="column right">
            <div className="question">
              ...
              <p>We encourage you to attend as it will be a great experience for you to learn and compete! You will work with a team and can ask any of our volunteers for help!
              There will also be workshops during the event to help you learn how to code.
              </p>
            </div>
            <div className="question">
